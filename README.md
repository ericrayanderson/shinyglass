...
| [Intensity slider example](https://github.com/ericrayanderson/shinyglass/blob/main/inst/examples/intensity-slider-demo.R) | iOS 27 **Ultra Clear -> Tinted** (`glass_intensity_slider()`); deploy via `--apps=intensity` |
