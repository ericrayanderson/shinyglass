...
Package under
[`python/`](https://ericrayanderson.github.io/shinyglass/python/) (not
on CRAN). Shares `inst/scss` + `inst/js`; wheels vendor precompiled CSS
so default themes need **no libsass** at runtime.
