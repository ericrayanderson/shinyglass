...
ui <- page_sidebar(
  ...
  # Stack beside a 280px sidebar at typical laptop widths (~1280px).
  # Side-by-side from Bootstrap xxl; package CSS still contains overflow
  # if an app uses a tighter 6/6 split.
  layout_columns(
